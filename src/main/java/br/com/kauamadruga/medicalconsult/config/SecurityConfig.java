...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception{
        ...
        auth.inMemoryAuthentication()
                .withUser("Kaua").password(passwordEncoder.encode("1234")).roles("ADMIN")
                .and()
                .withUser("pedro").password(passwordEncoder.encode("12345")).roles("SECRETARIO")
                .and()
                .withUser("rodrigo").password(passwordEncoder.encode("123456")).roles("PACIENTE");
    }
    @Bean
